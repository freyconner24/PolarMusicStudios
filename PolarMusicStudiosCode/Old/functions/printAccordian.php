...
echo "--------------------------";
	...
	$lyricsArray = array(
					...
					2 => array("title" => "Loving Askance", "number" => "Two", $loving),
					3 => array("title" => "Long Walks And Effervescence", "number" => "Three", $longwalks),
					4 => array("title" => "Vibrant Dreams And A Blank Canvas", "number" => "Four", $vibrant),
					5 => array("title" => "The Mountain And The Sea", "number" => "Five", $mountain),
					6 => array("title" => "Conversations", "number" => "Six", $conversations)
					);
