...
//$youtubeVidURL = "https://www.googleapis.com/youtube/v3/playlistItems?part=snippet&maxResults=10&playlistId=".$uploadPlaylistId."&key=AIzaSyCu22aIvFpmirab3xZwDkibk-h5QIJSqKw";
...
$youtubeVidURL = "https://www.googleapis.com/youtube/v3/playlistItems?part=snippet&maxResults=10&playlistId=PL5uscYEAt-qfJAatdV0ds5B-ELdOdBGyo&key=AIzaSyCu22aIvFpmirab3xZwDkibk-h5QIJSqKw";
...
<?php } else if($i % 4 == 1) { ?>
	<div class="row video-row">
		<div class="col-sm-5 cream-b box-L box">
			<div class="text crimson pacifico center-block text-center text-vert"><?php echo $title; ?></div>
		</div>
