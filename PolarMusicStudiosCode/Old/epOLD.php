			...
			<div class="panel panel-default">
				<div class="panel-body">
					<div class="page-header">
						<h3 class="my-h3">It's Coming on July 28th! &nbsp<small class="my-small-h3">&#8212 July 24th, 2014</small></h3>
						<!--<div class="row">
							<div class="col-sm-6">
						...
						<hr>
						<p class="my-quote"><i style="font-size: 18px;">"As I said before, <i>For Want Of A Letter</i> is literally my most precious project.  I had no idea that self-producing my own EP would be so rewarding, exciting, and heart wrenching all at the same time.  The release date is officially determined.  It will come out July 28th!!  Happy listening!" &nbsp;&#8212;CF</i></p>

						<hr>

						<h4 class="my-h4 my-title">Teaser Trailer</h4>
						<div class="row">
                                                        <div class="col-sm-12">
                                                                <div class="responsive-video"><iframe width="560" height="315" src="//www.youtube.com/embed/fMp3MjztojM" frameborder="0" allowfullscreen></iframe></div>
                                                        </div>
                                                </div>
						<hr>
