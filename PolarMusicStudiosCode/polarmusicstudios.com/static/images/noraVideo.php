...
$feedURL = 'http://gdata.youtube.com/feeds/api/users/UC1vJTvUDmBuOp82kBUtf6-Q/uploads?max-results=50';
...
<?php if($i % 4 == 0) { ?>
    <div class="row video-row">
		...
		<div class="col-sm-5 light-blue-b box-R box">
			<div class="text blue pacifico center-block text-center text-vert"><?php echo $title[1]; ?></div>
		</div>
	</div>
